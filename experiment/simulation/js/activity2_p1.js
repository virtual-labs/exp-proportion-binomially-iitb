function activity2_p1() {
    ...
    maindiv.innerHTML += `
      ...
      <div>
         ...
         <div class='row' id='act2-dd-div'>
            <div class='col-6'>Enter Alpha Value</div>
            <div class='col-6'>
               <select class='form-select fs-16px'  id='act2-alpha-inp'></select>
            </div>
            <br><br>
            <div>
               <button class='btn btn-info std-btn' onclick='a2_set_alpha();' id='act2-p1-btn-1' >Next</button>
            </div>
...
function a2_set_alpha() {
    let inp = (document.getElementById('act2-alpha-inp'));
    let next_btn = (document.getElementById('act2-p1-btn-2'));
    if (inp.value != '0') {
        ...
        // if (x1 == x2) {
        // 	z_alpha_a2 = z_table[indx][alpha_a2];
        // } else {
        // 	y1 = z_table[indx][alpha_a2];
        // 	y2 = z_table[indx - 1][alpha_a2];
        // 	let m = (y1 - y2) / (x1 - x2);
        // 	let c = y1 - m * x1;
        ...
        // console.log(x1, x2);
        // console.log(y1, y2);
        // console.log('z_alpha', z_alpha_a2);
        let s_2 = (document.getElementById('act2-dd-div'));
